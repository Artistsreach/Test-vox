...
import { Voxel, CharacterCustomization, InventoryItem, GameMode, WorldTheme } from './types';
...
const App: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden select-none touch-none">
      ...
      {(isCustomizing || isInventoryVisible) && <InventoryBar items={inventory} />}
      ...
      {lessonContent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
          <div className="bg-white rounded-xl w-full max-w-3xl max-h-[85vh] overflow-hidden flex flex-col shadow-2xl animate-in fade-in zoom-in duration-300">
            <div className="p-4 border-b flex justify-between items-center bg-blue-600 text-white">
              <div className="flex items-center gap-2">
                 <span className="text-2xl">🎓</span>
                 <h2 className="text-xl font-bold">Interactive Lesson</h2>
              </div>
              <button 
